""" шифрование Цезаря — это вид шифра подстановки, в котором
...
2) сделать одну функцию и для шифрования и для дешифрования
- для этого нужно добавить в функцию параметр direct
- пусть значение 0 - это зашифровать, а 1 - дешифровать """
